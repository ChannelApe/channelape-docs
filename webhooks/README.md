...
| Name                      | Source     | Usage                                                                                                                                        |
| ------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| VendorPartyInternalID     | SAP ByD    | Provided by SAP ByD. Only mapped so that ChannelApe can send asynchronous communucation back to SAP ByD.                                     |
| SenderPartyInternalID     | SAP ByD    | Provided by SAP ByD. Only mapped so that ChannelApe can send asynchronous communucation back to SAP ByD.                                     |
| RecipientPartyInternalID  | SAP ByD    | Provided by SAP ByD. Only mapped so that ChannelApe can send asynchronous communucation back to SAP ByD.                                     |
| ShippingDateTimePeriod    | SAP ByD    | Mapped to NRI's LastShipDate which is used as Delivery By Date                                                                               |
| ArrivalDateTimePeriod     | SAP ByD    | Not used.                                                                                                                                    |
| note_attributes_ship_from | ChannelApe | Legacy field from Pitney Bowes days. No longer used.                                                                                         |
| shipment_id               | ChannelApe | Generated by ChannelApe; NRI's ShipmentNumber + the CartonNumber. Used to uniquely identify a Carton Level Shipment Confirmation in SAP ByD. |
| warehouse_order_id        | ChannelApe | Sent to NRI in ClientReferenceNumber1. It is the purchaseOrderNumber + a suffix if multiple fulfillments were attempted.                     |
| Sscc                      | NRI        | GS1-128 barcode provided by NRI on carton level shipments. Currently not printed on retail labels.                                           |
| ShipmentNumber            | NRI        | NRI's unique Shipment Number.                                                                                                                |
| LicensePlate              | NRI        | NRI's unique License Plate Number currently printed on the retail labels in both plaintext and the barcode.                                  |
| CartonNumber              | NRI        | The carton number in a multi-carton shipment. e.g. 1, 2, 3, 4...                                                                             |
| Length                    | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| Width                     | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| Height                    | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| Weight                    | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| TotalOrderWeight          | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| TotalOrderCartons         | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| ClientTotalFreightCharge  | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
| TotalOrderCubeVolume      | NRI        | Provided by NRI on Shipment Confirmations. Not used.                                                                                         |
